...
export class TreeDataProviderGlobal implements vscode.TreeDataProvider<TreeNode>, vscode.Disposable {
...
// export const treeDataProviderGlobal: TreeDataProviderGlobal = new TreeDataProviderGlobal();
